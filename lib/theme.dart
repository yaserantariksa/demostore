...
Color viewMyOrderButtonColor = const Color(0xff39374B);
Color viewMyOrderTextButtonColor = const Color(0xffB7B6BF);
...
TextStyle viewMyOrderButtonTextStyle =
    GoogleFonts.poppins(color: viewMyOrderTextButtonColor);
